...
export cloud_zone="cloud.home.morinsoft.ca"
...
#password
export passwd_max_age=30
export passwd_min_age=1
export passwd_warn_age=14
...
# helper node credential
export helper_id="helper"
export helper_pwd="On32Secureh3lper~"
...
# Virtual machine memory (in MB)
export VM_MEM=4096
export VM_CPU=4
export VM_DISK_SIZE=50
export VM_HOST="kvmdc01.morinsoft.ca"
export VM_ISO="/var/lib/libvirt/images/Rocky-9.6-x86_64-boot.iso"
